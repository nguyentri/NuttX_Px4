/****************************************************************************
 * boards/arm/rzv/evk-rzv2h/examples/rzv2h_i2c_gy912.c
 *
...
#ifdef CONFIG_EVK_RZV2H_I2C_GY912_EXAMPLE
...
/* I2C0 Configuration for sensor expansion (RIIC0) */
#define I2C_PORT               BOARD_I2C_SENSOR_BUS
...
int rzv2h_gy912_read_data(struct gy912_data_s *data)
{
  int ret;
...
void rzv2h_gy912_print_data(const struct gy912_data_s *data)
{
  if (data == NULL)
    {
      return;
...
int rzv2h_i2c_gy912_test(void)
{
  ...
  for (i = 0; i < 10; i++)
    {
      ret = rzv2h_gy912_read_data(&data);
      if (ret < 0)
        {
...
#endif /* CONFIG_EVK_RZV2H_I2C_GY912_EXAMPLE */
