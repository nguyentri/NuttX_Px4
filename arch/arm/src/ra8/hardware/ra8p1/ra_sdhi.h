...
#define R_SDHI_SD_CMD                 (R_SDHI_BASE + R_SDHI_SD_CMD_OFFSET)
#define R_SDHI_SD_ARG                 (R_SDHI_BASE + R_SDHI_SD_ARG_OFFSET)
#define R_SDHI_SD_ARG1                 (R_SDHI_BASE + R_SDHI_SD_ARG1_OFFSET)
#define R_SDHI_SD_STOP                 (R_SDHI_BASE + R_SDHI_SD_STOP_OFFSET)
#define R_SDHI_SD_SECCNT                 (R_SDHI_BASE + R_SDHI_SD_SECCNT_OFFSET)
#define R_SDHI_SD_RSP10                 (R_SDHI_BASE + R_SDHI_SD_RSP10_OFFSET)
#define R_SDHI_SD_RSP1                 (R_SDHI_BASE + R_SDHI_SD_RSP1_OFFSET)
#define R_SDHI_SD_RSP32                 (R_SDHI_BASE + R_SDHI_SD_RSP32_OFFSET)
#define R_SDHI_SD_RSP3                 (R_SDHI_BASE + R_SDHI_SD_RSP3_OFFSET)
#define R_SDHI_SD_RSP54                 (R_SDHI_BASE + R_SDHI_SD_RSP54_OFFSET)
#define R_SDHI_SD_RSP5                 (R_SDHI_BASE + R_SDHI_SD_RSP5_OFFSET)
#define R_SDHI_SD_RSP76                 (R_SDHI_BASE + R_SDHI_SD_RSP76_OFFSET)
#define R_SDHI_SD_RSP7                 (R_SDHI_BASE + R_SDHI_SD_RSP7_OFFSET)
#define R_SDHI_SD_INFO1                 (R_SDHI_BASE + R_SDHI_SD_INFO1_OFFSET)
#define R_SDHI_SD_INFO2                 (R_SDHI_BASE + R_SDHI_SD_INFO2_OFFSET)
#define R_SDHI_SD_INFO1_MASK                 (R_SDHI_BASE + R_SDHI_SD_INFO1_MASK_OFFSET)
#define R_SDHI_SD_INFO2_MASK                 (R_SDHI_BASE + R_SDHI_SD_INFO2_MASK_OFFSET)
#define R_SDHI_SD_CLK_CTRL                 (R_SDHI_BASE + R_SDHI_SD_CLK_CTRL_OFFSET)
#define R_SDHI_SD_SIZE                 (R_SDHI_BASE + R_SDHI_SD_SIZE_OFFSET)
#define R_SDHI_SD_OPTION                 (R_SDHI_BASE + R_SDHI_SD_OPTION_OFFSET)
#define R_SDHI_SD_ERR_STS1                 (R_SDHI_BASE + R_SDHI_SD_ERR_STS1_OFFSET)
#define R_SDHI_SD_ERR_STS2                 (R_SDHI_BASE + R_SDHI_SD_ERR_STS2_OFFSET)
#define R_SDHI_SD_BUF0                 (R_SDHI_BASE + R_SDHI_SD_BUF0_OFFSET)
#define R_SDHI_SDIO_MODE                 (R_SDHI_BASE + R_SDHI_SDIO_MODE_OFFSET)
#define R_SDHI_SDIO_INFO1                 (R_SDHI_BASE + R_SDHI_SDIO_INFO1_OFFSET)
#define R_SDHI_SDIO_INFO1_MASK                 (R_SDHI_BASE + R_SDHI_SDIO_INFO1_MASK_OFFSET)
#define R_SDHI_SD_DMAEN                 (R_SDHI_BASE + R_SDHI_SD_DMAEN_OFFSET)
#define R_SDHI_SOFT_RST                 (R_SDHI_BASE + R_SDHI_SOFT_RST_OFFSET)
#define R_SDHI_SDIF_MODE                 (R_SDHI_BASE + R_SDHI_SDIF_MODE_OFFSET)
#define R_SDHI_EXT_SWAP                 (R_SDHI_BASE + R_SDHI_EXT_SWAP_OFFSET)
...
#  define R_SDHI_SD_CMD_CMDIDX_0X06                       (0 << R_SDHI_SD_CMD_CMDIDX_SHIFT)  /* CMD6 */
#  define R_SDHI_SD_CMD_CMDIDX_0X12                       (0 << R_SDHI_SD_CMD_CMDIDX_SHIFT)  /* CMD18 */
#  define R_SDHI_SD_CMD_CMDIDX_0X4D                       (0 << R_SDHI_SD_CMD_CMDIDX_SHIFT)  /* ACMD13 */
...
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0XFF                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X00                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/2 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X01                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/4 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X02                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/8 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X04                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/16 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X08                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/32 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X10                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/64 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X20                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/128 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X40                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/256 */
#  define R_SDHI_SD_CLK_CTRL_CLKSEL_0X80                  (0 << R_SDHI_SD_CLK_CTRL_CLKSEL_SHIFT)  /* PCLKB/512 */
...
#  define R_SDHI_SD_OPTION_CTOP_0X1                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 211 */
#  define R_SDHI_SD_OPTION_CTOP_0X2                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 212 */
#  define R_SDHI_SD_OPTION_CTOP_0X3                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 213 */
#  define R_SDHI_SD_OPTION_CTOP_0X4                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 214 */
#  define R_SDHI_SD_OPTION_CTOP_0X5                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 215 */
#  define R_SDHI_SD_OPTION_CTOP_0X6                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 216 */
#  define R_SDHI_SD_OPTION_CTOP_0X7                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 217 */
#  define R_SDHI_SD_OPTION_CTOP_0X8                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 218 */
#  define R_SDHI_SD_OPTION_CTOP_0X9                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 219 */
#  define R_SDHI_SD_OPTION_CTOP_0XA                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 220 */
#  define R_SDHI_SD_OPTION_CTOP_0XB                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 221 */
#  define R_SDHI_SD_OPTION_CTOP_0XC                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 222 */
#  define R_SDHI_SD_OPTION_CTOP_0XD                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 223 */
#  define R_SDHI_SD_OPTION_CTOP_0XE                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* PCLKB × 224 */
#  define R_SDHI_SD_OPTION_CTOP_0XF                       (0 << R_SDHI_SD_OPTION_CTOP_SHIFT)  /* Setting prohibited */
...
#  define R_SDHI_SD_OPTION_TOP_0X1                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 214 */
#  define R_SDHI_SD_OPTION_TOP_0X2                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 215 */
#  define R_SDHI_SD_OPTION_TOP_0X3                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 216 */
#  define R_SDHI_SD_OPTION_TOP_0X4                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 217 */
#  define R_SDHI_SD_OPTION_TOP_0X5                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 218 */
#  define R_SDHI_SD_OPTION_TOP_0X6                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 219 */
#  define R_SDHI_SD_OPTION_TOP_0X7                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 220 */
#  define R_SDHI_SD_OPTION_TOP_0X8                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 221 */
#  define R_SDHI_SD_OPTION_TOP_0X9                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 222 */
#  define R_SDHI_SD_OPTION_TOP_0XA                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 223 */
#  define R_SDHI_SD_OPTION_TOP_0XB                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 224 */
#  define R_SDHI_SD_OPTION_TOP_0XC                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 225 */
#  define R_SDHI_SD_OPTION_TOP_0XD                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 226 */
#  define R_SDHI_SD_OPTION_TOP_0XE                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* SDHI clock × 227 */
#  define R_SDHI_SD_OPTION_TOP_0XF                        (0 << R_SDHI_SD_OPTION_TOP_SHIFT)  /* Setting prohibited */
