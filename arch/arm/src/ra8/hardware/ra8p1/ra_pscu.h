...
#define R_PSCU_PSARD_PSARD16                      (1 << 16)  /* Peripheral security attribution bit 16 */
...
#define R_PSCU_PPARD_PPARD16                      (1 << 16)  /* Peripheral privilege attribution bit 16 */
...
#define R_PSCU_SFSAMON_SFS_MASK                   0xff8000
