...
#  define R_ACMPHS_CMPCTL_CDFS_00                         (0 << R_ACMPHS_CMPCTL_CDFS_SHIFT)  /* Noise filter not used. */
#  define R_ACMPHS_CMPCTL_CDFS_01                         (1 << R_ACMPHS_CMPCTL_CDFS_SHIFT)  /* Noise filter sampling frequency is 2^3/PCLKB. */
#  define R_ACMPHS_CMPCTL_CDFS_10                         (2 << R_ACMPHS_CMPCTL_CDFS_SHIFT)  /* Noise filter sampling frequency is 2^4/PCLKB.  */
#  define R_ACMPHS_CMPCTL_CDFS_11                         (3 << R_ACMPHS_CMPCTL_CDFS_SHIFT)  /* Noise filter sampling frequency is 2^5/PCLKB. */

#define R_ACMPHS_CMPCTL_CEG_SHIFT                 (3)  /* Selection of valid edge (Edge selector)  */
#define R_ACMPHS_CMPCTL_CEG_MASK                  0x18
#  define R_ACMPHS_CMPCTL_CEG_00                          (0 << R_ACMPHS_CMPCTL_CEG_SHIFT)  /* No edge selection. */
#  define R_ACMPHS_CMPCTL_CEG_01                          (1 << R_ACMPHS_CMPCTL_CEG_SHIFT)  /* Rising edge selection. */
#  define R_ACMPHS_CMPCTL_CEG_10                          (2 << R_ACMPHS_CMPCTL_CEG_SHIFT)  /* Falling edge selection */
#  define R_ACMPHS_CMPCTL_CEG_11                          (3 << R_ACMPHS_CMPCTL_CEG_SHIFT)  /* Both-edge selection */
...
#  define R_ACMPHS_CMPSEL0_CMPSEL_0000                    (0 << R_ACMPHS_CMPSEL0_CMPSEL_SHIFT)  /* Do not input */
#  define R_ACMPHS_CMPSEL0_CMPSEL_0001                    (1 << R_ACMPHS_CMPSEL0_CMPSEL_SHIFT)  /* Select IVCMP0 */
#  define R_ACMPHS_CMPSEL0_CMPSEL_0010                    (2 << R_ACMPHS_CMPSEL0_CMPSEL_SHIFT)  /* Select IVCMP1 */
#  define R_ACMPHS_CMPSEL0_CMPSEL_0100                    (4 << R_ACMPHS_CMPSEL0_CMPSEL_SHIFT)  /* Select IVCMP2 */
#  define R_ACMPHS_CMPSEL0_CMPSEL_1000                    (8 << R_ACMPHS_CMPSEL0_CMPSEL_SHIFT)  /* Select IVCMP3 */
...
#define R_ACMPHS_CPIOC_VREFEN                     (1 << 7)  /* Internal Vref enable */

#define R_ACMPHS_CPIOC_CPOE                       (1 << 0)  /* Comparator output selection */
...
#define R_ACMPHS_CPMSKCTL_MSKSEL_SHIFT            (0)  /* Comparator Interrupt Periodic Mask Enable */
...
#  define R_ACMPHS_CPMSKCTL_MSKSEL_101                    (5 << R_ACMPHS_CPMSKCTL_MSKSEL_SHIFT)  /* Enable interrupt masking by GTIO5A output signal */
#  define R_ACMPHS_CPMSKCTL_MSKSEL_110                    (6 << R_ACMPHS_CPMSKCTL_MSKSEL_SHIFT)  /* Enable interrupt masking by GTIO6A output signal */
#  define R_ACMPHS_CPMSKCTL_MSKSEL_111                    (7 << R_ACMPHS_CPMSKCTL_MSKSEL_SHIFT)  /* Enable interrupt masking by GTIO7A output signal */


/* Maximum number of channels */

#define ACMPHS_MAX_CHANNELS    6
