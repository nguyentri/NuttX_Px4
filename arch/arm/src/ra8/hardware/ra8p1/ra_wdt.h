...
#define R_WDT_CH_STRIDE    0x00000100
#define R_WDT_CH_BASE(ch)   (R_WDT_BASE + ((uint32_t)(ch) * R_WDT_CH_STRIDE))
...
#define R_WDT_WDTCR_RPSS_SHIFT                    (12)  /* Window Start Position Selection */
...
#  define R_WDT_WDTCR_RPSS_11                             (3 << R_WDT_WDTCR_RPSS_SHIFT)  /* 100% (window start position is not specified) */

#define R_WDT_WDTCR_RPES_SHIFT                    (8)  /* Window End Position Selection */
...
#  define R_WDT_WDTCR_RPES_11                             (3 << R_WDT_WDTCR_RPES_SHIFT)  /* 0% (window end position is not specified) */

#define R_WDT_WDTCR_CKS_SHIFT                     (4)  /* Clock Division Ratio Selection */
#define R_WDT_WDTCR_CKS_MASK                      0xf0
#  define R_WDT_WDTCR_CKS_0001                            (1 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/4 */
#  define R_WDT_WDTCR_CKS_0100                            (4 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/64 */
#  define R_WDT_WDTCR_CKS_1111                            (15 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/128 */
#  define R_WDT_WDTCR_CKS_0110                            (6 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/512 */
#  define R_WDT_WDTCR_CKS_0111                            (7 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/2048 */
#  define R_WDT_WDTCR_CKS_1000                            (8 << R_WDT_WDTCR_CKS_SHIFT)  /* PCLK/8192 */

#define R_WDT_WDTCR_TOPS_SHIFT                    (0)  /* Timeout Period Selection */
#define R_WDT_WDTCR_TOPS_MASK                     0x3
#  define R_WDT_WDTCR_TOPS_00                             (0 << R_WDT_WDTCR_TOPS_SHIFT)  /* 1,024 cycles (03FFh) */
#  define R_WDT_WDTCR_TOPS_01                             (1 << R_WDT_WDTCR_TOPS_SHIFT)  /* 4,096 cycles (0FFFh) */
#  define R_WDT_WDTCR_TOPS_10                             (2 << R_WDT_WDTCR_TOPS_SHIFT)  /* 8,192 cycles (1FFFh) */
#  define R_WDT_WDTCR_TOPS_11                             (3 << R_WDT_WDTCR_TOPS_SHIFT)  /* 16,384 cycles (3FFFh) */
...
#define R_WDT_WDTRCR_RSTIRQS                      (1 << 7)  /* Reset Interrupt Request Selection */

/* WDTCSTPR Register bit definitions */
#define R_WDT_WDTCSTPR_SLCSTP                     (1 << 7)  /* Sleep-Mode Count Stop Control */


/* Maximum number of channels */

#define WDT_MAX_CHANNELS    2
