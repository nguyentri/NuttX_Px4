...
#define R_CPU_CTRL_CH_STRIDE    0x00000004
#define R_CPU_CTRL_CH_BASE(ch)   (R_CPU_CTRL_BASE + ((uint32_t)(ch) * R_CPU_CTRL_CH_STRIDE))

/* CPU_CTRL Register Offsets */

/* CPU%sLCKUPCR Registers (0-1) */
#define R_CPU_CTRL_CPU0LCKUPCR_OFFSET     0x00000030  /* CPU0 Lockup Control Register */
#define R_CPU_CTRL_CPU1LCKUPCR_OFFSET     0x00000034  /* CPU1 Lockup Control Register */
/* CPU%sINITVTOR Registers (0-1) */
#define R_CPU_CTRL_CPU0INITVTOR_OFFSET     0x00000040  /* CPU Initial Vector Base Address Register */
#define R_CPU_CTRL_CPU1INITVTOR_OFFSET     0x00000044  /* CPU Initial Vector Base Address Register */
/* CPU%sWAITCR Registers (0-1) */
#define R_CPU_CTRL_CPU0WAITCR_OFFSET     0x00000050  /* CPU0 CPUWAIT Control Register */
#define R_CPU_CTRL_CPU1WAITCR_OFFSET     0x00000054  /* CPU1 CPUWAIT Control Register */
/* CPU%sACTCSR Registers (0-1) */
#define R_CPU_CTRL_CPU0ACTCSR_OFFSET     0x00000060  /* CPU0 Activation Control and Status Register */
#define R_CPU_CTRL_CPU1ACTCSR_OFFSET     0x00000064  /* CPU1 Activation Control and Status Register */
...
#define R_CPU_CTRL_CPU0CRPT_OFFSET     0x00000840  /* CPU0 Control Register Protection Register */
#define R_CPU_CTRL_CPU1CRPT_OFFSET     0x00000844  /* CPU1 Control Register Protection Register */

/* CPU_CTRL Register Addresses */

#define R_CPU_CTRL_CPU0LCKUPCR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU0LCKUPCR_OFFSET)
#define R_CPU_CTRL_CPU1LCKUPCR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU1LCKUPCR_OFFSET)
#define R_CPU_CTRL_CPU0INITVTOR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU0INITVTOR_OFFSET)
#define R_CPU_CTRL_CPU1INITVTOR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU1INITVTOR_OFFSET)
#define R_CPU_CTRL_CPU0WAITCR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU0WAITCR_OFFSET)
#define R_CPU_CTRL_CPU1WAITCR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU1WAITCR_OFFSET)
#define R_CPU_CTRL_CPU0ACTCSR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU0ACTCSR_OFFSET)
#define R_CPU_CTRL_CPU1ACTCSR                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU1ACTCSR_OFFSET)
...
#define R_CPU_CTRL_CPU0CRPT                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU0CRPT_OFFSET)
#define R_CPU_CTRL_CPU1CRPT                 (R_CPU_CTRL_BASE + R_CPU_CTRL_CPU1CRPT_OFFSET)
