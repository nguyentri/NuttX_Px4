...
#define R_SCI_B_RDR_BY_OFFSET                     0x00000000  /* Receive Data Register (byte access) */
...
#define R_SCI_B_ICR_OFFSET                        0x00000020  /* Simple I2C Control Register */
...
#define R_SCI_B_XCR0_OFFSET                       0x00000034  /* Simple LIN(SCIX) Control Register 0 */
#define R_SCI_B_XCR1_OFFSET                       0x00000038  /* Simple LIN(SCIX) Control Register 1 */
#define R_SCI_B_XCR2_OFFSET                       0x0000003c  /* Simple LIN(SCIX) Control Register 2 */
#define R_SCI_B_CSR_OFFSET                        0x00000048  /* Common Status Register */
#define R_SCI_B_ISR_OFFSET                        0x0000004c  /* Simple I2C Status Register */
...
#define R_SCI_B_XSR0_OFFSET                       0x0000005c  /* Simple LIN (SCIX) Status Register 0 */
#define R_SCI_B_XSR1_OFFSET                       0x00000060  /* Simple LIN(SCIX) Status Register 1 */
#define R_SCI_B_CFCLR_OFFSET                      0x00000068  /* Common Flag Clear Register */
#define R_SCI_B_ICFCLR_OFFSET                     0x0000006c  /* Simple I2C Flag Clear Register */
...
#define R_SCI_B_XFCLR_OFFSET                      0x00000078  /* Simple LIN(SCIX) Flag Clear Register */
...
#define R_SCI_B_TDR_BY(n)                         (R_SCI_B_CH_BASE(n) + R_SCI_B_TDR_BY_OFFSET)
...
/* TDR_BY Register bit definitions */
#define R_SCI_B_TDR_BY_TDAT_SHIFT                 (0)  /* Serial transmit data */
#define R_SCI_B_TDR_BY_TDAT_MASK                  0xff
...
#define R_SCI_B_CCR2_BRME                         (1 << 16)  /* Bit Modulation Enable */
...
#  define R_SCI_B_CCR3_MOD_100                            (4 << R_SCI_B_CCR3_MOD_SHIFT)  /* Simple I2C mode */
...
#  define R_SCI_B_CCR3_CKE_00                             (0 << R_SCI_B_CCR3_CKE_SHIFT)  /* On-chip baud rate generator
The SCKn pin is available for use as an I/O port in accord with the I/O port settings.
 */
#  define R_SCI_B_CCR3_CKE_01                             (1 << R_SCI_B_CCR3_CKE_SHIFT)  /* On-chip baud rate generator
The clock with the same frequency as the bit rate is output from the SCKn pin.
 */
...
#define R_SCI_B_CCR4_SCKSEL                       (1 << 19)  /* Master receive clock selection bit. */

#define R_SCI_B_CCR4_AST_SHIFT                    (24)  /* Adjustment value for receive Sampling Timing */
#define R_SCI_B_CCR4_AST_MASK                     0x7000000
#  define R_SCI_B_CCR4_AST_000                            (0 << R_SCI_B_CCR4_AST_SHIFT)  /* 1TCLK delay */
#  define R_SCI_B_CCR4_AST_001                            (1 << R_SCI_B_CCR4_AST_SHIFT)  /* 2TCLK delay */
#  define R_SCI_B_CCR4_AST_010                            (2 << R_SCI_B_CCR4_AST_SHIFT)  /* 3TCLK delay */
#  define R_SCI_B_CCR4_AST_011                            (3 << R_SCI_B_CCR4_AST_SHIFT)  /* 4TCLK delay */
...
#define R_SCI_B_XCR2_CF0D_SHIFT                   (0)  /* Control Field 0compare data */
...
#define R_SCI_B_CSR_MFF                           (1 << 26)  /* Mode Fault Flag */
