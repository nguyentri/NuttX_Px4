...
#  define R_SCI0_SMR              (R_SCI0_B_BASE + R_SCI_SMR_OFFSET)
#  define R_SCI0_BRR              (R_SCI0_B_BASE + R_SCI_BRR_OFFSET)
#  define R_SCI0_SCR              (R_SCI0_B_BASE + R_SCI_SCR_OFFSET)
#  define R_SCI0_TDR              (R_SCI0_B_BASE + R_SCI_TDR_OFFSET)
#  define R_SCI0_SSR              (R_SCI0_B_BASE + R_SCI_SSR_OFFSET)
#  define R_SCI0_RDR              (R_SCI0_B_BASE + R_SCI_RDR_OFFSET)
#  define R_SCI0_SCMR             (R_SCI0_B_BASE + R_SCI_SCMR_OFFSET)
#  define R_SCI0_SEMR             (R_SCI0_B_BASE + R_SCI_SEMR_OFFSET)
#  define R_SCI0_SNFR             (R_SCI0_B_BASE + R_SCI_SNFR_OFFSET)
#  define R_SCI0_SIMR1            (R_SCI0_B_BASE + R_SCI_SIMR1_OFFSET)
#  define R_SCI0_SIMR2            (R_SCI0_B_BASE + R_SCI_SIMR2_OFFSET)
#  define R_SCI0_SIMR3            (R_SCI0_B_BASE + R_SCI_SIMR3_OFFSET)
#  define R_SCI0_SISR             (R_SCI0_B_BASE + R_SCI_SISR_OFFSET)
#  define R_SCI0_SPMR             (R_SCI0_B_BASE + R_SCI_SPMR_OFFSET)
#  define R_SCI0_TDRHL            (R_SCI0_B_BASE + R_SCI_TDRHL_OFFSET)
#  define R_SCI0_FTDRHL           (R_SCI0_B_BASE + R_SCI_FTDRHL_OFFSET)
#  define R_SCI0_RDRHL            (R_SCI0_B_BASE + R_SCI_RDRHL_OFFSET)
#  define R_SCI0_FRDRHL           (R_SCI0_B_BASE + R_SCI_FRDRHL_OFFSET)
#  define R_SCI0_MDDR             (R_SCI0_B_BASE + R_SCI_MDDR_OFFSET)
#  define R_SCI0_DCCR             (R_SCI0_B_BASE + R_SCI_DCCR_OFFSET)
#  define R_SCI0_FCR              (R_SCI0_B_BASE + R_SCI_FCR_OFFSET)
#  define R_SCI0_FDR              (R_SCI0_B_BASE + R_SCI_FDR_OFFSET)
#  define R_SCI0_LSR              (R_SCI0_B_BASE + R_SCI_LSR_OFFSET)
#  define R_SCI0_CDR              (R_SCI0_B_BASE + R_SCI_CDR_OFFSET)
#  define R_SCI0_SPTR             (R_SCI0_B_BASE + R_SCI_SPTR_OFFSET)

/* SCI1  Registers */

#  define R_SCI1_SMR              (R_SCI1_B_BASE + R_SCI_SMR_OFFSET)
#  define R_SCI1_BRR              (R_SCI1_B_BASE + R_SCI_BRR_OFFSET)
#  define R_SCI1_SCR              (R_SCI1_B_BASE + R_SCI_SCR_OFFSET)
#  define R_SCI1_TDR              (R_SCI1_B_BASE + R_SCI_TDR_OFFSET)
#  define R_SCI1_SSR              (R_SCI1_B_BASE + R_SCI_SSR_OFFSET)
#  define R_SCI1_RDR              (R_SCI1_B_BASE + R_SCI_RDR_OFFSET)
#  define R_SCI1_SCMR             (R_SCI1_B_BASE + R_SCI_SCMR_OFFSET)
#  define R_SCI1_SEMR             (R_SCI1_B_BASE + R_SCI_SEMR_OFFSET)
#  define R_SCI1_SNFR             (R_SCI1_B_BASE + R_SCI_SNFR_OFFSET)
#  define R_SCI1_SIMR1            (R_SCI1_B_BASE + R_SCI_SIMR1_OFFSET)
#  define R_SCI1_SIMR2            (R_SCI1_B_BASE + R_SCI_SIMR2_OFFSET)
#  define R_SCI1_SIMR3            (R_SCI1_B_BASE + R_SCI_SIMR3_OFFSET)
#  define R_SCI1_SISR             (R_SCI1_B_BASE + R_SCI_SISR_OFFSET)
#  define R_SCI1_SPMR             (R_SCI1_B_BASE + R_SCI_SPMR_OFFSET)
#  define R_SCI1_TDRHL            (R_SCI1_B_BASE + R_SCI_TDRHL_OFFSET)
#  define R_SCI1_FTDRHL           (R_SCI1_B_BASE + R_SCI_FTDRHL_OFFSET)
#  define R_SCI1_RDRHL            (R_SCI1_B_BASE + R_SCI_RDRHL_OFFSET)
#  define R_SCI1_FRDRHL           (R_SCI1_B_BASE + R_SCI_FRDRHL_OFFSET)
#  define R_SCI1_MDDR             (R_SCI1_B_BASE + R_SCI_MDDR_OFFSET)
#  define R_SCI1_DCCR             (R_SCI1_B_BASE + R_SCI_DCCR_OFFSET)
#  define R_SCI1_FCR              (R_SCI1_B_BASE + R_SCI_FCR_OFFSET)
#  define R_SCI1_FDR              (R_SCI1_B_BASE + R_SCI_FDR_OFFSET)
#  define R_SCI1_LSR              (R_SCI1_B_BASE + R_SCI_LSR_OFFSET)
#  define R_SCI1_CDR              (R_SCI1_B_BASE + R_SCI_CDR_OFFSET)
#  define R_SCI1_SPTR             (R_SCI1_B_BASE + R_SCI_SPTR_OFFSET)

/* SCI2  Registers (No FIFO) */

#  define R_SCI2_SMR              (R_SCI2_B_BASE + R_SCI_SMR_OFFSET)
#  define R_SCI2_BRR              (R_SCI2_B_BASE + R_SCI_BRR_OFFSET)
#  define R_SCI2_SCR              (R_SCI2_B_BASE + R_SCI_SCR_OFFSET)
#  define R_SCI2_TDR              (R_SCI2_B_BASE + R_SCI_TDR_OFFSET)
#  define R_SCI2_SSR              (R_SCI2_B_BASE + R_SCI_SSR_OFFSET)
#  define R_SCI2_RDR              (R_SCI2_B_BASE + R_SCI_RDR_OFFSET)
#  define R_SCI2_SCMR             (R_SCI2_B_BASE + R_SCI_SCMR_OFFSET)
#  define R_SCI2_SEMR             (R_SCI2_B_BASE + R_SCI_SEMR_OFFSET)
#  define R_SCI2_SNFR             (R_SCI2_B_BASE + R_SCI_SNFR_OFFSET)
#  define R_SCI2_SIMR1            (R_SCI2_B_BASE + R_SCI_SIMR1_OFFSET)
#  define R_SCI2_SIMR2            (R_SCI2_B_BASE + R_SCI_SIMR2_OFFSET)
#  define R_SCI2_SIMR3            (R_SCI2_B_BASE + R_SCI_SIMR3_OFFSET)
#  define R_SCI2_SISR             (R_SCI2_B_BASE + R_SCI_SISR_OFFSET)
#  define R_SCI2_SPMR             (R_SCI2_B_BASE + R_SCI_SPMR_OFFSET)
#  define R_SCI2_TDRHL            (R_SCI2_B_BASE + R_SCI_TDRHL_OFFSET)
#  define R_SCI2_RDRHL            (R_SCI2_B_BASE + R_SCI_RDRHL_OFFSET)
#  define R_SCI2_MDDR             (R_SCI2_B_BASE + R_SCI_MDDR_OFFSET)
#  define R_SCI2_DCCR             (R_SCI2_B_BASE + R_SCI_DCCR_OFFSET)
#  define R_SCI2_CDR              (R_SCI2_B_BASE + R_SCI_CDR_OFFSET)
#  define R_SCI2_SPTR             (R_SCI2_B_BASE + R_SCI_SPTR_OFFSET)

/* SCI9  Registers (No FIFO) */

#  define R_SCI9_SMR              (R_SCI9_B_BASE + R_SCI_SMR_OFFSET)
#  define R_SCI9_BRR              (R_SCI9_B_BASE + R_SCI_BRR_OFFSET)
#  define R_SCI9_SCR              (R_SCI9_B_BASE + R_SCI_SCR_OFFSET)
#  define R_SCI9_TDR              (R_SCI9_B_BASE + R_SCI_TDR_OFFSET)
#  define R_SCI9_SSR              (R_SCI9_B_BASE + R_SCI_SSR_OFFSET)
#  define R_SCI9_RDR              (R_SCI9_B_BASE + R_SCI_RDR_OFFSET)
#  define R_SCI9_SCMR             (R_SCI9_B_BASE + R_SCI_SCMR_OFFSET)
#  define R_SCI9_SEMR             (R_SCI9_B_BASE + R_SCI_SEMR_OFFSET)
#  define R_SCI9_SNFR             (R_SCI9_B_BASE + R_SCI_SNFR_OFFSET)
#  define R_SCI9_SIMR1            (R_SCI9_B_BASE + R_SCI_SIMR1_OFFSET)
#  define R_SCI9_SIMR2            (R_SCI9_B_BASE + R_SCI_SIMR2_OFFSET)
#  define R_SCI9_SIMR3            (R_SCI9_B_BASE + R_SCI_SIMR3_OFFSET)
#  define R_SCI9_SISR             (R_SCI9_B_BASE + R_SCI_SISR_OFFSET)
#  define R_SCI9_SPMR             (R_SCI9_B_BASE + R_SCI_SPMR_OFFSET)
#  define R_SCI9_TDRHL            (R_SCI9_B_BASE + R_SCI_TDRHL_OFFSET)
#  define R_SCI9_RDRHL            (R_SCI9_B_BASE + R_SCI_RDRHL_OFFSET)
#  define R_SCI9_MDDR             (R_SCI9_B_BASE + R_SCI_MDDR_OFFSET)
#  define R_SCI9_DCCR             (R_SCI9_B_BASE + R_SCI_DCCR_OFFSET)
#  define R_SCI9_CDR              (R_SCI9_B_BASE + R_SCI_CDR_OFFSET)
#  define R_SCI9_SPTR             (R_SCI9_B_BASE + R_SCI_SPTR_OFFSET)
