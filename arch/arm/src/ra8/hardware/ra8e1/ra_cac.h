/****************************************************************************
 * arch/arm/src/ra8/hardware/ra8e1/ra_cac.h
 *
...
#ifndef __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CAC_H
#define __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CAC_H
...
#  define R_CAC_CACR1_FMCS_000                            (0 << R_CAC_CACR1_FMCS_SHIFT)  /* Main clock oscillator (CACMCLK) */
#  define R_CAC_CACR1_FMCS_001                            (1 << R_CAC_CACR1_FMCS_SHIFT)  /* Sub-clock oscillator (CACSCLK) */
#  define R_CAC_CACR1_FMCS_010                            (2 << R_CAC_CACR1_FMCS_SHIFT)  /* HOCO clock (CACHCLK) */
#  define R_CAC_CACR1_FMCS_011                            (3 << R_CAC_CACR1_FMCS_SHIFT)  /* MOCO clock (CACMOCLK) */
#  define R_CAC_CACR1_FMCS_100                            (4 << R_CAC_CACR1_FMCS_SHIFT)  /* LOCO clock (CACLCLK) */
#  define R_CAC_CACR1_FMCS_101                            (5 << R_CAC_CACR1_FMCS_SHIFT)  /* Peripheral module clock B (PCLKB) */
#  define R_CAC_CACR1_FMCS_110                            (6 << R_CAC_CACR1_FMCS_SHIFT)  /* Setting prohibited */
#  define R_CAC_CACR1_FMCS_111                            (7 << R_CAC_CACR1_FMCS_SHIFT)  /* Setting prohibited */

#define R_CAC_CACR1_TCSS_SHIFT                    (4)  /* Timer Count Clock Source Select */
...
#  define R_CAC_CACR2_RSCS_000                            (0 << R_CAC_CACR2_RSCS_SHIFT)  /* Main clock oscillator (CACMCLK) */
#  define R_CAC_CACR2_RSCS_001                            (1 << R_CAC_CACR2_RSCS_SHIFT)  /* Sub-clock oscillator (CACSCLK) */
#  define R_CAC_CACR2_RSCS_010                            (2 << R_CAC_CACR2_RSCS_SHIFT)  /* HOCO clock (CACHCLK) */
#  define R_CAC_CACR2_RSCS_011                            (3 << R_CAC_CACR2_RSCS_SHIFT)  /* MOCO clock (CACMOCLK) */
#  define R_CAC_CACR2_RSCS_100                            (4 << R_CAC_CACR2_RSCS_SHIFT)  /* LOCO clock (CACLCLK) */
#  define R_CAC_CACR2_RSCS_101                            (5 << R_CAC_CACR2_RSCS_SHIFT)  /* Peripheral module clock B (PCLKB) */
#  define R_CAC_CACR2_RSCS_110                            (6 << R_CAC_CACR2_RSCS_SHIFT)  /* Setting prohibited */
...
#  define R_CAC_CACR2_RCDS_00                             (0 << R_CAC_CACR2_RCDS_SHIFT)  /* x 1/32 clock */
#  define R_CAC_CACR2_RCDS_01                             (1 << R_CAC_CACR2_RCDS_SHIFT)  /* x 1/128 clock */
#  define R_CAC_CACR2_RCDS_10                             (2 << R_CAC_CACR2_RCDS_SHIFT)  /* x 1/1024 clock */
#  define R_CAC_CACR2_RCDS_11                             (3 << R_CAC_CACR2_RCDS_SHIFT)  /* x 1/8192 clock */

#define R_CAC_CACR2_DFS_SHIFT                     (6)  /* Digital Filter Select */
#define R_CAC_CACR2_DFS_MASK                      0xc0
#  define R_CAC_CACR2_DFS_00                              (0 << R_CAC_CACR2_DFS_SHIFT)  /* Disable digital filtering */
#  define R_CAC_CACR2_DFS_01                              (1 << R_CAC_CACR2_DFS_SHIFT)  /* Use sampling clock for the digital filter as the frequency measuring clock */
#  define R_CAC_CACR2_DFS_10                              (2 << R_CAC_CACR2_DFS_SHIFT)  /* Use sampling clock for the digital filter as the frequency measuring clock divided by 4 */
#  define R_CAC_CACR2_DFS_11                              (3 << R_CAC_CACR2_DFS_SHIFT)  /* Use sampling clock for the digital filter as the frequency measuring clock divided by 16. */
...
#endif /* __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CAC_H */
