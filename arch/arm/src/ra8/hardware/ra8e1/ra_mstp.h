/****************************************************************************
 * arch/arm/src/ra8/hardware/ra8e1/ra_mstp.h
 *
...
#ifndef __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_MSTP_H
#define __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_MSTP_H
...
#define R_MSTP_MSTPCRA_MSTPA0                     (1 << 0)  /* Unnecessary Circuit Module Stop */

#define R_MSTP_MSTPCRA_MSTPA1                     (1 << 1)  /* SRAM1 Module Stop */

#define R_MSTP_MSTPCRA_MSTPA15                    (1 << 15)  /* Standby SRAM Module Stop */

#define R_MSTP_MSTPCRA_MSTPA22                    (1 << 22)  /* DMA Controller and Data Transfer Controller Module Stop */
...
#define R_MSTP_MSTPCRB_MSTPB8                     (1 << 8)  /* I2C Bus Interface 1 Module Stop */

#define R_MSTP_MSTPCRB_MSTPB9                     (1 << 9)  /* I2C Bus Interface 0 Module Stop */

#define R_MSTP_MSTPCRB_MSTPB11                    (1 << 11)  /* Universal Serial Bus 2.0 FS Interface Module Stop */

#define R_MSTP_MSTPCRB_MSTPB15                    (1 << 15)  /* ETHERC0 and EDMAC0 Controller Module Stop */

#define R_MSTP_MSTPCRB_MSTPB16                    (1 << 16)  /* Octal Serial Peripheral Interface Module Stop */
...
#define R_MSTP_MSTPCRD_MSTPD15                    (1 << 15)  /* 12-bit A/D Converter 1 Module Stop */

#define R_MSTP_MSTPCRD_MSTPD16                    (1 << 16)  /* 12-bit A/D Converter 0 Module Stop */

#define R_MSTP_MSTPCRD_MSTPD20                    (1 << 20)  /* 12-bit D/A Converter Module Stop */
...
#define R_MSTP_MSTPCRE_MSTPE18                    (1 << 18)  /* General PWM Timer 13 Module */

#define R_MSTP_MSTPCRE_MSTPE19                    (1 << 19)  /* General PWM Timer 12 Module */

#define R_MSTP_MSTPCRE_MSTPE20                    (1 << 20)  /* General PWM Timer 11 Module */

#define R_MSTP_MSTPCRE_MSTPE21                    (1 << 21)  /* General PWM Timer 10 Module */

#define R_MSTP_MSTPCRE_MSTPE26                    (1 << 26)  /* General PWM Timer 5 Module */

#define R_MSTP_MSTPCRE_MSTPE27                    (1 << 27)  /* General PWM Timer 4 Module */

#define R_MSTP_MSTPCRE_MSTPE28                    (1 << 28)  /* General PWM Timer 3 Module */

#define R_MSTP_MSTPCRE_MSTPE29                    (1 << 29)  /* General PWM Timer 2 Module */

#define R_MSTP_MSTPCRE_MSTPE30                    (1 << 30)  /* General PWM Timer 1 Module */

#define R_MSTP_MSTPCRE_MSTPE31                    (1 << 31)  /* General PWM Timer 0 Module */
...
#endif /* __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_MSTP_H */
