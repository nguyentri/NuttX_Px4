/****************************************************************************
 * arch/arm/src/ra8/hardware/ra8e1/ra_ssie.h
 *
...
#ifndef __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_SSIE_H
#define __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_SSIE_H
...
#define R_SSIE_SSIFSR_RDC_SHIFT                   (8)  /* Receive Data Count */
#define R_SSIE_SSIFSR_RDC_MASK                    0x3f00

#define R_SSIE_SSIFSR_TDE                         (1 << 16)  /* Transmit Data Empty Flag */

#define R_SSIE_SSIFSR_TDC_SHIFT                   (24)  /* Transmit Data Count */
...
#endif /* __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_SSIE_H */
