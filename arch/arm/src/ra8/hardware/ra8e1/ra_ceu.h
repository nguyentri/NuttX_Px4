/****************************************************************************
 * arch/arm/src/ra8/hardware/ra8e1/ra_ceu.h
 *
...
#ifndef __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CEU_H
#define __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CEU_H
...
#  define R_CEU_CAMCR_DTARY_00                            (0 << R_CEU_CAMCR_DTARY_SHIFT)  /* Image input data is fetched in the order of Cb0, Y0, Cr0, and Y1  */
#  define R_CEU_CAMCR_DTARY_01                            (1 << R_CEU_CAMCR_DTARY_SHIFT)  /* Image input data is fetched in the order of Cr0, Y0, Cb0, and Y1  */
#  define R_CEU_CAMCR_DTARY_10                            (2 << R_CEU_CAMCR_DTARY_SHIFT)  /* Image input data is fetched in the order of Y0, Cb0, Y1, and Cr0  */
#  define R_CEU_CAMCR_DTARY_11                            (3 << R_CEU_CAMCR_DTARY_SHIFT)  /* Image input data is fetched in the order of Y0, Cr0, Y1, and Cb0  */
...
#endif /* __ARCH_ARM_SRC_RA8_HARDWARE_RA8E1_CEU_H */
