...
#  define R_SYSTEM_VBTCR1                (R_SYSC_BASE + R_SYSTEM_VBTCR1_OFFSET)
#  define R_SYSTEM_VBTCR2                (R_SYSC_BASE + R_SYSTEM_VBTCR2_OFFSET)
#  define R_SYSTEM_VBTSR                 (R_SYSC_BASE + R_SYSTEM_VBTSR_OFFSET)
#  define R_SYSTEM_VBTCMPCR              (R_SYSC_BASE + R_SYSTEM_VBTCMPCR_OFFSET)
#  define R_SYSTEM_VBTLVDICR             (R_SYSC_BASE + R_SYSTEM_VBTLVDICR_OFFSET)
#  define R_SYSTEM_VBTWCTLR              (R_SYSC_BASE + R_SYSTEM_VBTWCTLR_OFFSET)
#  define R_SYSTEM_VBTWCH0OTSR           (R_SYSC_BASE + R_SYSTEM_VBTWCH0OTSR_OFFSET)
#  define R_SYSTEM_VBTWCH1OTSR           (R_SYSC_BASE + R_SYSTEM_VBTWCH1OTSR_OFFSET)
#  define R_SYSTEM_VBTWCH2OTSR           (R_SYSC_BASE + R_SYSTEM_VBTWCH2OTSR_OFFSET)
#  define R_SYSTEM_VBTICTLR              (R_SYSC_BASE + R_SYSTEM_VBTICTLR_OFFSET)
#  define R_SYSTEM_VBTOCTLR              (R_SYSC_BASE + R_SYSTEM_VBTOCTLR_OFFSET)
#  define R_SYSTEM_VBTWTER               (R_SYSC_BASE + R_SYSTEM_VBTWTER_OFFSET)
#  define R_SYSTEM_VBTWEGR               (R_SYSC_BASE + R_SYSTEM_VBTWEGR_OFFSET)
#  define R_SYSTEM_VBTWFR                (R_SYSC_BASE + R_SYSTEM_VBTWFR_OFFSET)
#  define R_SYSTEM_VBTBKR(p)             (R_SYSC_BASE + R_SYSTEM_VBTBKR_OFFSET + p*0x0001)
#  define R_SYSTEM_SCKDIVCR              (R_SYSC_BASE + R_SYSTEM_SCKDIVCR_OFFSET)
#  define R_SYSTEM_SCKDIVCR2             (R_SYSC_BASE + R_SYSTEM_SCKDIVCR2_OFFSET)
#  define R_SYSTEM_SCKSCR                (R_SYSC_BASE + R_SYSTEM_SCKSCR_OFFSET)
#  define R_SYSTEM_PLLCR                 (R_SYSC_BASE + R_SYSTEM_PLLCR_OFFSET)
#  define R_SYSTEM_PLLCCR                (R_SYSC_BASE + R_SYSTEM_PLLCCR_OFFSET)
#  define R_SYSTEM_BCKCR                 (R_SYSC_BASE + R_SYSTEM_BCKCR_OFFSET)
#  define R_SYSTEM_MOSCCR                (R_SYSC_BASE + R_SYSTEM_MOSCCR_OFFSET)
#  define R_SYSTEM_HOCOCR                (R_SYSC_BASE + R_SYSTEM_HOCOCR_OFFSET)
#  define R_SYSTEM_HOCOCR2               (R_SYSC_BASE + R_SYSTEM_HOCOCR2_OFFSET)
#  define R_SYSTEM_MOCOCR                (R_SYSC_BASE + R_SYSTEM_MOCOCR_OFFSET)
#  define R_SYSTEM_FLLCR1                (R_SYSC_BASE + R_SYSTEM_FLLCR1_OFFSET)
#  define R_SYSTEM_FLLCR2                (R_SYSC_BASE + R_SYSTEM_FLLCR2_OFFSET)
#  define R_SYSTEM_OSCSF                 (R_SYSC_BASE + R_SYSTEM_OSCSF_OFFSET)
#  define R_SYSTEM_CKOCR                 (R_SYSC_BASE + R_SYSTEM_CKOCR_OFFSET)
#  define R_SYSTEM_TRCKCR                (R_SYSC_BASE + R_SYSTEM_TRCKCR_OFFSET)
#  define R_SYSTEM_OSTDCR                (R_SYSC_BASE + R_SYSTEM_OSTDCR_OFFSET)
#  define R_SYSTEM_OSTDSR                (R_SYSC_BASE + R_SYSTEM_OSTDSR_OFFSET)
#  define R_SYSTEM_PLL2CCR               (R_SYSC_BASE + R_SYSTEM_PLL2CCR_OFFSET)
#  define R_SYSTEM_PLL2CR                (R_SYSC_BASE + R_SYSTEM_PLL2CR_OFFSET)
#  define R_SYSTEM_PLLCCR2               (R_SYSC_BASE + R_SYSTEM_PLLCCR2_OFFSET)
#  define R_SYSTEM_PLL2CCR2              (R_SYSC_BASE + R_SYSTEM_PLL2CCR2_OFFSET)
#  define R_SYSTEM_EBCKOCR               (R_SYSC_BASE + R_SYSTEM_EBCKOCR_OFFSET)
#  define R_SYSTEM_SDCKOCR               (R_SYSC_BASE + R_SYSTEM_SDCKOCR_OFFSET)
#  define R_SYSTEM_SCICKDIVCR            (R_SYSC_BASE + R_SYSTEM_SCICKDIVCR_OFFSET)
#  define R_SYSTEM_SCICKCR               (R_SYSC_BASE + R_SYSTEM_SCICKCR_OFFSET)
#  define R_SYSTEM_SPICKDIVCR            (R_SYSC_BASE + R_SYSTEM_SPICKDIVCR_OFFSET)
#  define R_SYSTEM_SPICKCR               (R_SYSC_BASE + R_SYSTEM_SPICKCR_OFFSET)
#  define R_SYSTEM_ADCCKDIVCR            (R_SYSC_BASE + R_SYSTEM_ADCCKDIVCR_OFFSET)
#  define R_SYSTEM_ADCCKCR               (R_SYSC_BASE + R_SYSTEM_ADCCKCR_OFFSET)
#  define R_SYSTEM_GPTCKDIVCR            (R_SYSC_BASE + R_SYSTEM_GPTCKDIVCR_OFFSET)
#  define R_SYSTEM_GPTCKCR               (R_SYSC_BASE + R_SYSTEM_GPTCKCR_OFFSET)
#  define R_SYSTEM_LCDCKDIVCR            (R_SYSC_BASE + R_SYSTEM_LCDCKDIVCR_OFFSET)
#  define R_SYSTEM_LCDCKCR               (R_SYSC_BASE + R_SYSTEM_LCDCKCR_OFFSET)
#  define R_SYSTEM_MOCOUTCR              (R_SYSC_BASE + R_SYSTEM_MOCOUTCR_OFFSET)
#  define R_SYSTEM_HOCOUTCR              (R_SYSC_BASE + R_SYSTEM_HOCOUTCR_OFFSET)
#  define R_SYSTEM_USBCKDIVCR            (R_SYSC_BASE + R_SYSTEM_USBCKDIVCR_OFFSET)
#  define R_SYSTEM_OCTACKDIVCR           (R_SYSC_BASE + R_SYSTEM_OCTACKDIVCR_OFFSET)
#  define R_SYSTEM_CANFDCKDIVCR          (R_SYSC_BASE + R_SYSTEM_CANFDCKDIVCR_OFFSET)
#  define R_SYSTEM_USB60CKDIVCR          (R_SYSC_BASE + R_SYSTEM_USB60CKDIVCR_OFFSET)
#  define R_SYSTEM_I3CCKDIVCR            (R_SYSC_BASE + R_SYSTEM_I3CCKDIVCR_OFFSET)
#  define R_SYSTEM_USBCKCR               (R_SYSC_BASE + R_SYSTEM_USBCKCR_OFFSET)
#  define R_SYSTEM_OCTACKCR              (R_SYSC_BASE + R_SYSTEM_OCTACKCR_OFFSET)
#  define R_SYSTEM_CANFDCKCR             (R_SYSC_BASE + R_SYSTEM_CANFDCKCR_OFFSET)
#  define R_SYSTEM_USB60CKCR             (R_SYSC_BASE + R_SYSTEM_USB60CKCR_OFFSET)
#  define R_SYSTEM_I3CCKCR               (R_SYSC_BASE + R_SYSTEM_I3CCKCR_OFFSET)
#  define R_SYSTEM_OPCCR                 (R_SYSC_BASE + R_SYSTEM_OPCCR_OFFSET)
#  define R_SYSTEM_MOSCWTCR              (R_SYSC_BASE + R_SYSTEM_MOSCWTCR_OFFSET)
#  define R_SYSTEM_HOCOWTCR              (R_SYSC_BASE + R_SYSTEM_HOCOWTCR_OFFSET)
#  define R_SYSTEM_SOPCCR                (R_SYSC_BASE + R_SYSTEM_SOPCCR_OFFSET)
#  define R_SYSTEM_LOCOCR                (R_SYSC_BASE + R_SYSTEM_LOCOCR_OFFSET)
#  define R_SYSTEM_SOSCCR                (R_SYSC_BASE + R_SYSTEM_SOSCCR_OFFSET)
#  define R_SYSTEM_MOMCR                 (R_SYSC_BASE + R_SYSTEM_MOMCR_OFFSET)
#  define R_SYSTEM_SOMCR                 (R_SYSC_BASE + R_SYSTEM_SOMCR_OFFSET)
#  define R_SYSTEM_LOCOUTCR              (R_SYSC_BASE + R_SYSTEM_LOCOUTCR_OFFSET)
#  define R_SYSTEM_SBYCR                 (R_SYSC_BASE + R_SYSTEM_SBYCR_OFFSET)
#  define R_SYSTEM_SNZCR                 (R_SYSC_BASE + R_SYSTEM_SNZCR_OFFSET)
#  define R_SYSTEM_SNZEDCR               (R_SYSC_BASE + R_SYSTEM_SNZEDCR_OFFSET)
#  define R_SYSTEM_SNZREQCR              (R_SYSC_BASE + R_SYSTEM_SNZREQCR_OFFSET)
#  define R_SYSTEM_FLSTOP                (R_SYSC_BASE + R_SYSTEM_FLSTOP_OFFSET)
#  define R_SYSTEM_OPCCR                 (R_SYSC_BASE + R_SYSTEM_OPCCR_OFFSET)
#  define R_SYSTEM_SOPCCR                (R_SYSC_BASE + R_SYSTEM_SOPCCR_OFFSET)
#  define R_SYSTEM_SYOCDCR               (R_SYSC_BASE + R_SYSTEM_SYOCDCR_OFFSET)
#  define R_SYSTEM_LVCMPCR               (R_SYSC_BASE + R_SYSTEM_LVCMPCR_OFFSET)
#  define R_SYSTEM_LVDLVLR               (R_SYSC_BASE + R_SYSTEM_LVDLVLR_OFFSET)
#  define R_SYSTEM_LVDCR0                (R_SYSC_BASE + R_SYSTEM_LVDCR0_OFFSET)
#  define R_SYSTEM_LVDCR1                (R_SYSC_BASE + R_SYSTEM_LVDCR1_OFFSET)
#  define R_SYSTEM_LVDSR                 (R_SYSC_BASE + R_SYSTEM_LVDSR_OFFSET)
#  define R_SYSTEM_PRCR                  (R_SYSC_BASE + R_SYSTEM_PRCR_OFFSET)
#  define R_SYSTEM_RSTSR0                (R_SYSC_BASE + R_SYSTEM_RSTSR0_OFFSET)
#  define R_SYSTEM_RSTSR2                (R_SYSC_BASE + R_SYSTEM_RSTSR2_OFFSET)
#  define R_SYSTEM_RSTSR1                (R_SYSC_BASE + R_SYSTEM_RSTSR1_OFFSET)
#  define R_SYSTEM_BKRACR                (R_SYSC_BASE + R_SYSTEM_BKRACR_OFFSET)
