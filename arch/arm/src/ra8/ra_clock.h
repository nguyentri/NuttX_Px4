...
#define RA_PCLK_SCICLK      0   /* SCI clock */
#define RA_PCLK_SPICLK      1   /* SPI clock */
#define RA_PCLK_CANFDCLK    2  /* CANFD clock */
#define RA_PCLK_GPTCLK      3  /* GPT clock */
#define RA_PCLK_IICCLK      4  /* IIC (I2C) clock */
#define RA_PCLK_ADCCLK      5  /* ADC clock */
#define RA_PCLK_OCTACLK     6  /* OSPI clock */
#define RA_PCLK_LCDCLK      7  /* LCD clock */
#define RA_PCLK_I3CCLK      8  /* I3C clock */
#define RA_PCLK_USB60CLK    9  /* USB 60MHz clock */
#define RA_PCLK_ESWCLK      10  /* Ethernet Switch clock */
#define RA_PCLK_ESWPHYCLK   11  /* Ethernet Switch PHY clock */
#define RA_PCLK_ETHPHYCLK   12  /* Ethernet PHY clock */
