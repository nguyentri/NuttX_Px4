...
#define RZV_INTC_GIC_GICD_ICDISER_OFFSET(n)              (0x1000 + ((n) * 0x04))
#define RZV_INTC_GIC_GICD_ICDICER_OFFSET(n)              (0x1080 + ((n) * 0x04))
#define RZV_INTC_GIC_GICD_ICDISPR_OFFSET(n)              (0x1100 + ((n) * 0x04))
#define RZV_INTC_GIC_GICD_ICDICPR_OFFSET(n)              (0x1180 + ((n) * 0x04))
#define RZV_INTC_GIC_GICD_ICDABR_OFFSET(n)               (0x1200 + ((n) * 0x04))
...
#define RZV_INTC_GIC_GICD_ICDISER(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDISER_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDICER(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDICER_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDISPR(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDISPR_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDICPR(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDICPR_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDABR(n)                  (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDABR_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDIPR(n)                  (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDIPR_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDIPTR(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDIPTR_OFFSET(n))
#define RZV_INTC_GIC_GICD_ICDICFR(n)                 (RZV_INTC_GIC_BASE + RZV_INTC_GIC_GICD_ICDICFR_OFFSET(n))
