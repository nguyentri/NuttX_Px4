...
#ifndef __ARCH_ARM_INCLUDE_RZV_CHIP_H
#define __ARCH_ARM_INCLUDE_RZV_CHIP_H
 ...
 * the processor implements bits[7:3] of each field, bits[2:0] read as zero
 * and ignore writes.
 */

#define GIC_IRQ_PRIORITY_MIN        0xf8 /* All bits[7:3] set is minimum priority */
...
#endif /* __ARCH_ARM_INCLUDE_RZV_CHIP_H */